...
excludes
{
      "qt_moc/moc_texteditorsettings.cpp"
    , "qt_moc/moc_syntaxhighlighter.cpp"
    , "qt_moc/moc_tips.cpp"
}
...
qt4.INSTALL 
{ 
      "TextEditor.pluginspec"
    , solution().basedir .. "/bin/libTextEditor*.so" 
    , solution().basedir .. "/bin/TextEditor*.dll" 
}

qt4.RESOURCES { "texteditor.qrc" }

substitutes.Add("QTCREATOR_VERSION", "2.3.1")
qt4.SUBSTITUTE("TextEditor.pluginspec.in")
